...
<div class="container py-5 d-flex flex-column align-items-center text-center">
    ...
    <section class="mb-5 w-100" style="max-width: 720px;">
        ...
        <p>We’re on a mission to reconnect people with the power of green through the ancient tradition of matcha—made for modern living. One cup at a time, we’re making wellness a daily ritual.</p>
        <img src="{{ asset('images/monk-making-matcha.jpg') }}" alt="Matcha Ritual" class="img-fluid rounded shadow mt-3">
    </section>
    ...
    <section class="mb-5 w-100" style="max-width: 720px;">
        ...
        <img src="{{ asset('images/Product/IMG_2993.png') }}" alt="Matcha Products" width="500" class="img-fluid rounded shadow mt-4">
    </section>

    <!-- Team Section -->
    <section class="mb-5 w-100" style="max-width: 720px;">
        <h2 class="text-success mb-3">🧑‍🤝‍🧑 Our Team</h2>
        <p>We’re a tight-knit crew of tea sommeliers, wellness experts, and designers committed to making matcha approachable, authentic, and exciting for everyone.</p>
